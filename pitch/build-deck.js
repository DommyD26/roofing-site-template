...
(async () => {
  ...
  // ------------------------------------------------------------- 6. BREAK-EVEN
  {
    ...
    s.addText("Model assumptions", { x: 0.95, y: 2.0, w: 3.9, h: 0.4, fontSize: 16, bold: true, color: BLACK, fontFace: "Arial", margin: 0 });
    s.addText([
      { text: "Avg. insurance replacement job", options: { bullet: true, breakLine: true, bold: true } },
      { text: "$12,000 revenue", options: { color: RED, bold: true, breakLine: true, paraSpaceAfter: 8, indentLevel: 1 } },
      { text: "Gross margin", options: { bullet: true, breakLine: true, bold: true } },
      { text: "35%  →  ~$4,200 gross profit / job", options: { color: RED, bold: true, breakLine: true, paraSpaceAfter: 8, indentLevel: 1 } },
      { text: "Jobs to break even", options: { bullet: true, breakLine: true, bold: true } },
      { text: "annual cost ÷ $4,200", options: { color: RED, bold: true, indentLevel: 1 } },
    ], { x: 0.95, y: 2.45, w: 3.9, h: 2.4, fontSize: 13.5, color: INK, fontFace: "Arial", margin: 0 });
    s.addText("Placeholder benchmarks — swap in T-Rock's actual avg. ticket and margin before the meeting.", {
